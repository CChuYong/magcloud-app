...
Future<String> userNicknameDialog() async {
                        ...
                        child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(message('generic_change_nickname'),
                                    style: TextStyle(
                                      color: BaseColor.warmGray700,
                                      fontSize: 16.sp,
                                    )),
                                SizedBox(height: 6.sp),
                                Text(message('message_nickname_change_info'),
                                    style: TextStyle(
